...
<html lang="es">
  <head>
    ...
    <title>Gestión de Materiales por Sucursal - Sistema de Reciclaje</title>
        ...
        <div class="container">
          <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
              <div>
                <h3 class="fw-bold mb-3">Gestión de Materiales por Sucursal</h3>
                <h6 class="op-7 mb-2">Gestionar el inventario por producto y sucursal</h6>
              </div>
